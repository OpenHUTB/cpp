...
thousand bodies and then the actor and component overhead, not the solver, becomes the limit &mdash; as the [Physics Cube Bench](./Physics-Cube-Bench.md) shows.
...
Full API and configuration detail in [Instanced Physics](../Physics/Instanced-Physics.md).
